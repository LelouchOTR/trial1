        ...
        >
          ...
          <Pagination // Create a Pagination component
            classNames={{
              ...
              selectedItem:
                "flex items-center justify-center px-3 h-8 text-slate-600 border border-gray-300 bg-sky-200 hover:bg-sky-100 hover:text-sky-700 dark:border-gray-700 dark:bg-sky-700 dark:text-white",
